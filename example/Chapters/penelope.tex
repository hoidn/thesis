...
\begin{equation}
\phi (r) = e 4 \pi [\frac{1}{r}\int_0^{r}\rho(r^')r^{'2} + \int_r^{\infty}\rho_n(r^')r^'dr^'] -
e 4 \pi \frac{1}{r} \int_0^r\rho_e(r^')r^{'2}dr^' + \int_r^\infty \rho_e(r^') r^' dr^'].
\end{equation}
In general (and in PENELOPE's treatment) the 
