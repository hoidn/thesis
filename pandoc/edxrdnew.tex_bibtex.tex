...
generated in the impulse approximation
 \cite{schulke2007electron, eisenberger1970compton}
...
%\begin{equation}
%\begin{split}
%I_{total}(E) = d\Omega_{det} N_{atoms} \tau(E, e \theta) \frac{d\sigma_t}{d\Omega} \\
%&\times [I_{incident}(E) f(k)^2 S(k) + I_{incident}(E\*)\int_0^\inf dE' S_{incoh}(k, \omega). \mathrm{(6)}
%\end{split}
%\end{equation}
...
approximation \cite{eisenberger1970compton}
